...
관련 문서:
- [시스템 개발 과정 일부](<docs(haru2)/status/status-2026-02-08-2026-03-28-app-flow.md>)
...
관련 문서:
- [최종 결과 요약](infra/docs/performance/evidence/keda/2단계_retry_2/summary.md)
...
참고 증거:
- [1차 실험 요약](infra/docs/performance/evidence/concurrent_max=40/README.md)
- [핵심 로그](infra/docs/performance/evidence/concurrent_max=40/ai-load-test-important-logs.txt)
...
관련 문서:
- [1차 실험 로그](infra/docs/performance/evidence/keda/1단계_retry/step1-low-load-retry-logs.txt)
